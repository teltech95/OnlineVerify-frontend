  ...
  return (
    <div className="App">
      <form onSubmit={handleSubmit}>
        <p>{error}</p>
        <h1>Register</h1>
        <div className={validName ? "form-control" : "form-control error"}>
        ...
        <div className={validPass ? "form-control" : "form-control error"}>
        ...
        <div className={checkMatch ? "form-control" : "form-control error"}>
        ...
        <button
          disabled={
            !email || !validName || !validPass || !checkMatch ? true : false
          }
        >
          Submit
        </button>
